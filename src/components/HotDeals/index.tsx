				...
				<div className="container  grid  lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-1  justify-center border-[2px] border-slate-100 ">
					<div className="mainDeal mb-[10px] row-span-2 col-span-2 ">
						...
						<div className="my-[16px]">
							<p className="text-center text-[16px] text-[var(--priceGrey)]">
								Hurry up! Offer ends In:
							</p>
							<div className="Timecontainer flex items-start justify-center text-[20px] font-medium gap-4 text-center">
								<div className="day">
									<h4>02</h4>
